...
public class MyStack3<AnyType> implements Iterable<AnyType>
{
    /**
...
class Nest
{
	 ...
	 {
		 MyStack3<String> lst = new MyStack3<>( );
		 String list = "{ [ ( ) ] [ ] }";
	     System.out.println("The symbols are:"+list);
